...
"color: rgb(0, 0, 0);")
        ...
        self.create_lesson.setGeometry(QtCore.QRect(30, 510, 200, 50))
        self.create_lesson.setMinimumSize(QtCore.QSize(200, 50))
        self.create_lesson.setMaximumSize(QtCore.QSize(200, 50))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        ...
        self.create_lesson.setStyleSheet("background-color: rgb(246, 184, 49);\n"
"color: rgb(0, 0, 0);")
        self.create_lesson.setObjectName("create_lesson")
        self.create_mentor = QtWidgets.QPushButton(self.teacher_plan)
        self.create_mentor.setGeometry(QtCore.QRect(490, 510, 200, 50))
        self.create_mentor.setMinimumSize(QtCore.QSize(200, 50))
        self.create_mentor.setSizeIncrement(QtCore.QSize(200, 50))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.create_mentor.setStyleSheet("background-color: rgb(246, 184, 49);\n"
"color: rgb(0, 0, 0);")
        self.create_mentor.setObjectName("create_mentor")
        self.update_lessons = QtWidgets.QPushButton(self.teacher_plan)
        self.update_lessons.setGeometry(QtCore.QRect(260, 510, 200, 50))
        self.update_lessons.setMinimumSize(QtCore.QSize(200, 50))
        self.update_lessons.setMaximumSize(QtCore.QSize(200, 50))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.update_lessons.setStyleSheet("background-color: rgb(246, 184, 49);\n"
"color: rgb(0, 0, 0);")
        self.update_lessons.setObjectName("update_lessons")
        self.update_mentoring = QtWidgets.QPushButton(self.teacher_plan)
        self.update_mentoring.setGeometry(QtCore.QRect(720, 510, 200, 50))
        self.update_mentoring.setMinimumSize(QtCore.QSize(200, 50))
        self.update_mentoring.setSizeIncrement(QtCore.QSize(200, 50))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(11)
        font.setBold(True)
        ...
        self.update_mentoring.setStyleSheet("background-color: rgb(246, 184, 49);\n"
"color: rgb(0, 0, 0);")
...
"color: rgb(0, 0, 0);")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 30, 410, 144))
